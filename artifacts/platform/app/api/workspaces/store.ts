...
export async function resolveAuthorizedSourceIds(
  ...
  // When a workspaceId is supplied we MUST intersect by it. When null, fall
  // back to the historical "any source you own" semantic so the legacy
  // research surface (no workspaceId yet) keeps working.

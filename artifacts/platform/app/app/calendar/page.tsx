...
export default function CalendarPage() {
  ...
  return (
    <div style={{ padding: '1.75rem', maxWidth: 1500, margin: '0 auto' }}>
      ...
      {/* Connector Hub: surface workspace-installed earnings/calendar feeds
          right next to the standard FMP-sourced events, using the same
          executor pipeline as /api/v1/connectors/[slug]/[op]. */}
      <div style={{ marginBottom: 18 }}>
        <ConnectorDataPanel mode="earnings" title="Earnings data from your connections" />
      </div>

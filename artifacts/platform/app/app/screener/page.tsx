...
import { AltDataSection, FocusPicker } from '@/components/alt-data/cards'
...
export default function ScreenerPage() {
  ...
  useEffect(() => {
    if (!filtered.length) { setFocusSymbol(null); return }
    setFocusSymbol(prev => (prev && filtered.some(s => s.symbol === prev)) ? prev : filtered[0].symbol)
  }, [filtered])
      ...
      <div style={{display:'grid',gridTemplateColumns:'280px 1fr',gap:16,alignItems:'start'}}>
        ...
        {focusSymbol && (
          <div style={{marginTop:18}}>
            ...
            <AltDataSection symbol={focusSymbol} companyName={focusName} />
          </div>
        )}
      </div>
    </div>

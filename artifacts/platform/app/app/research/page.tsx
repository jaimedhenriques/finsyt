                      ...
                      */}
                      ...
                      {m.answer && (
                        <div>
                          ...
                          {/* "Data sources used" transparency footer — lists every
                              provider/connector the agent touched, with role,
                              response time, citation count, and a deep link to
                              the Connector Hub. Hidden when the workspace
                              setting is off. */}
                          {m.trace && m.trace.length > 0 && (
                            <DataSourcesUsedFooter trace={m.trace} />
                          )}
                        </div>
                      )}
                    </div>

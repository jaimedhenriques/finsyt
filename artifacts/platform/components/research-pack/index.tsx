...
const DEMO_SUMMARY_ITEMS: SmartSummaryItem[] = [
  ...
  { ticker:'MSFT', doc:'expert-script', date:'Feb 12', source:'Tegus — ex-Azure GM',            sentiment:'pos', highlight:'Copilot ARR run-rate now ~$5B; attach rates in E5 SKUs ahead of plan.' },

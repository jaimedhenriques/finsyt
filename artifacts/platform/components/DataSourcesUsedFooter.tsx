 ...
 * - Each row links to the Connector Hub deep link so users can audit the
 *   provider that fed the answer.
 */
export default function DataSourcesUsedFooter({ trace, caption, compact }: Props) {

        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 20px' }}>
          {record.excerpt && (
            <div style={{ marginBottom: 16 }}>
              <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--text-muted)', marginBottom: 6 }}>
                Grounding passage
              </div>
              <div style={{ fontSize: 12.5, lineHeight: 1.6, color: 'var(--text-secondary)', padding: '10px 12px', borderLeft: '3px solid var(--accent)', background: 'var(--bg-elevated)', borderRadius: 8 }}>
                {record.excerpt}
              </div>
            </div>
          )}
          ...
          {records.length > 0 && (
            <div style={{ marginBottom: 16 }}>
              <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--text-muted)', marginBottom: 8 }}>Records from this source</div>

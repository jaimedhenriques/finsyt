...
| 2026-04-28 | `floating-finsyt-agent` | adapter-only | https://21st.dev/components/floating-agent | _hand-rolled adapter, see `components/ui/floating-finsyt-agent.tsx`_ |

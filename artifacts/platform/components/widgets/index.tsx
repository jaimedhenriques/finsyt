...
export function CompanySummaryWidget() {
  ...
  const summaries: Record<string,string> = {
    ...
    MSFT:'Microsoft is the enterprise AI platform of record. Azure AI services are on a $10bn+ annualised run rate with GitHub AI assistants driving productivity suite attachment. Operating leverage is improving — FY2026 operating margin expected above 45%.',
  }
  return (

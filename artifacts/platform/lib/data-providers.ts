...
export const PROVIDERS = {
  massive:          process.env.MASSIVE_API_KEY            || process.env.massive_key_api    || process.env.POLYGON_API_KEY      || '',
...
export const PROVIDER_META: Record<string, {
  label:    string
  category: 'fundamentals' | 'quotes' | 'news' | 'macro' | 'alt' | 'ai' | 'private' | 'design'
  ...
  yahoo: {
    label:'Yahoo Finance (RapidAPI)', category:'quotes', tier:'fallback',
    coverage:'Global tickers, free-tier convenience layer',
    fields:['quotes','statistics','holders','recommendations'],

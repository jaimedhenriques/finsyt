...
export async function register() {
  if (process.env.NEXT_RUNTIME === "nodejs") {
    const { assertRlsSafe, bootstrapRls, ensureDeckOverridesSchema, ensureReportsSchema, ensureLiveHighlightsSchema, ensureWorkspaceViewsSchema, ensureWorkflowsSchema } = await import("@workspace/db");

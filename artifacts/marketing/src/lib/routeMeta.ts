...
export const ROUTE_META: Record<string, RouteMeta> = {
  ...
  "/excel": {
    title: "Finsyt for Excel — Agentic research inside your workbook | Finsyt",
    description:
      "Finsyt for Excel is an agentic research add-in: AI chat that sees your sheet, an autonomous Build loop, one-click DCF/Comps/WACC templates, and live =FINSYT.* worksheet functions — every write previewed and approved.",
    ogTitle: "Finsyt for Excel — Agentic research inside your workbook",
    ogDescription:
      "AI chat, autonomous model building, one-click templates, and live =FINSYT.* functions inside Excel. Every write is previewed and approved before it touches a cell.",
    canonical: `${FINSYT_URL}/excel`,
    schema: {
      "@context": "https://schema.org",
      "@type": "SoftwareApplication",
      name: "Finsyt for Excel",
      applicationCategory: "FinanceApplication",
      operatingSystem: "Microsoft Excel (Windows, Mac, Web)",
      url: `${FINSYT_URL}/excel`,
      description:
        "An agentic research add-in for Microsoft Excel: AI chat that sees your sheet, an autonomous Build loop, one-click DCF/Comps/Sensitivity/WACC templates, and live =FINSYT.* worksheet functions.",
      featureList: [
        "AI research agent in the Excel task pane",
        "Autonomous model builder with preview and approval",
        "One-click DCF, Comps, Sensitivity, and WACC templates",
        "Live =FINSYT.* worksheet functions with source attribution",
        "Clerk SSO and API key authentication",
      ],
      publisher: ORGANIZATION,
    },
  },

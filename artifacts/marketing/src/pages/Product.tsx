...
import { ArrowRight, Search, FileText, BarChart3, ChevronRight, Workflow, ShieldCheck, ExternalLink } from "lucide-react";
      ...
      <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center py-16 border-t border-border">
          <div>
            ...
            <h2 className="text-3xl font-display font-bold mb-4">Every answer shows its work.</h2>
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <ChevronRight className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                <span><strong>Provider, role, response time, citations</strong> — surfaced beside every answer.</span>
              </li>
              <li className="flex items-start gap-3">
                <ChevronRight className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                <span><strong>Deck appendix slide</strong> mirrors the chat footer so investment memos stay self-attributed.</span>
              </li>
              <li className="flex items-start gap-3">
                <ChevronRight className="w-5 h-5 text-primary shrink-0 mt-0.5" />

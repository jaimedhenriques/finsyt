...
export function Footer() {
  return (
    <footer className="bg-[#0F111F] text-white mt-20">
      ...
      {/* Main Footer */}
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            ...
            <li><Link href="/excel" className="text-sm text-white/60 hover:text-white transition-colors">Finsyt for Excel</Link></li>
            <li><Link href="/compare" className="text-sm text-white/60 hover:text-white transition-colors">Compare</Link></li>
            <li><Link href="/pricing" className="text-sm text-white/60 hover:text-white transition-colors">Pricing</Link></li>
          </ul>
        </div>

        <div>
          <h3 className="font-semibold text-white mb-4 text-sm">Developers</h3>
          <ul className="flex flex-col gap-3">
            <li><Link href="/developers" className="text-sm text-white/60 hover:text-white transition-colors">Integrations &amp; MCP</Link></li>
            <li><a href="/api/mcp" target="_blank" rel="noopener noreferrer" className="text-sm text-white/60 hover:text-white transition-colors">MCP Tool Manifest</a></li>
            <li><a href="/api/v1" target="_blank" rel="noopener noreferrer" className="text-sm text-white/60 hover:text-white transition-colors">REST API Reference</a></li>
            <li><a href="/platform/app/connectors" className="text-sm text-white/60 hover:text-white transition-colors">Connector Hub</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            ...
            <li><Link href="/security" className="text-sm text-white/60 hover:text-white transition-colors">Trust Center</Link></li>
          </ul>
        </div>
      </div>

      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <div className="flex items-center gap-4 border-l pl-6 border-border">
            <a href="/platform/app" className="text-sm font-medium text-foreground hover:text-primary transition-colors">
              Sign in
            </a>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 top-[60px] bg-background border-t border-border p-6 flex flex-col h-[calc(100vh-60px)]">
          ...
          <div className="mt-auto flex flex-col gap-4 pb-8">
            <a href="/platform/app" onClick={() => setMobileMenuOpen(false)} className="block">

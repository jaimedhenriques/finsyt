...
// ── Trust strip ───────────────────────────────────────────────────────────────
function TrustStrip() {
  const providers = ['EODHD', 'FactSet', 'SEC EDGAR', 'FRED', 'Finnhub', 'FMP', 'CoreSignal', 'Perplexity']
  return (
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Screen across 50,000+ global equities using Capital IQ-style formula mnemonics. Build, save, and export screens with PE, revenue growth, margins, and custom multi-factor logic.',
...
// ── Social proof ──────────────────────────────────────────────────────────────
const TESTIMONIALS = [
  { quote: "Replaced three tools with Finsyt. The research quality is on par with FactSet at a fraction of the cost.", name: "Head of Research, Hedge Fund", initials: "HR" },

    ...
    <div style={{ minHeight: '100vh', background: '#080E1A', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: "'Inter', -apple-system, sans-serif" }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ marginTop: 12, color: '#7A8EAE', fontSize: 14 }}>Institutional-grade financial intelligence</p>
        </div>

        {/* Card */}
        <div style={{ background: '#0D1627', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: '36px 32px' }}>
          <h1 style={{ fontSize: '1.25rem', fontWeight: 800, color: '#fff', marginBottom: 6, letterSpacing: '-0.02em' }}>Sign in to Finsyt</h1>
          <p style={{ fontSize: 14, color: '#7A8EAE', marginBottom: 28 }}>Access live financial data and AI research</p>
          ...
          <form onSubmit={handleEmailLogin}>
            ...
            <div style={{ textAlign: 'right', marginBottom: 20 }}>
              <Link href="/app/auth/reset-password" style={{ fontSize: 12, color: '#93B4FF', textDecoration: 'none', fontWeight: 500 }}>Forgot password?</Link>
            </div>
          ...
          <p style={{ textAlign: 'center', marginTop: 24, fontSize: 13, color: '#7A8EAE' }}>
            ...
            <Link href="/app/auth/signup" style={{ color: '#93B4FF', textDecoration: 'none', fontWeight: 600 }}>Sign up free</Link>
          </p>
        </div>

        <p style={{ textAlign: 'center', marginTop: 20, fontSize: 12, color: '#3D5270' }}>
          By signing in, you agree to our{' '}
          <a href="#" style={{ color: '#4A6280', textDecoration: 'underline' }}>Terms of Service</a>
          {' '}and{' '}
          <a href="#" style={{ color: '#4A6280', textDecoration: 'underline' }}>Privacy Policy</a>
        </p>
      </div>
    </div>
  )

    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#F5F7FB", fontFamily: "'Inter', system-ui, sans-serif" }}>
      <div style={{ width: "100%", maxWidth: 420, padding: "2.5rem", background: "#fff", borderRadius: 16, border: "1px solid #E2E8F2", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <p style={{ color: "#7D8FA9", fontSize: "0.875rem", marginTop: "0.5rem" }}>Sign in to your account</p>
        </div>
        ...
        <form onSubmit={handleLogin}>
          <label style={{ display: "block", marginBottom: "1rem" }}>
            ...
            <input
              ...
              style={{ width: "100%", padding: "0.625rem 0.875rem", borderRadius: 8, border: "1px solid #E2E8F2", fontSize: "0.875rem", outline: "none", transition: "border 0.15s", background: "#FAFBFD" }}
          ...
          <button
            type="submit"
            disabled={loading}
            style={{ width: "100%", padding: "0.7rem", borderRadius: 8, background: "#1B4FFF", color: "#fff", fontWeight: 600, fontSize: "0.875rem", border: "none", cursor: loading ? "not-allowed" : "pointer", opacity: loading ? 0.7 : 1, transition: "opacity 0.15s" }}
          >
        ...
        <button
          ...
          style={{ width: "100%", padding: "0.7rem", borderRadius: 8, background: "#fff", color: "#1C2B4A", fontWeight: 600, fontSize: "0.875rem", border: "1px solid #E2E8F2", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", transition: "background 0.15s" }}
        ...
        <p style={{ textAlign: "center", marginTop: "1.5rem", fontSize: "0.8125rem", color: "#7D8FA9" }}>
          ...
          <Link href={`/app/auth/signup?next=${encodeURIComponent(next)}`} style={{ color: "#1B4FFF", fontWeight: 600, textDecoration: "none" }}>
            Sign up
          </Link>
        </p>
      </div>

    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          background: '#fff', borderRadius: 16, boxShadow: '0 24px 80px rgba(0,0,0,0.3)',
          textAlign: 'center',
        }}>
          <div style={{
          ...
          <h2 style={{ fontSize: 20, fontWeight: 800, color: '#0A1628', marginBottom: 8 }}>Check your email</h2>
          <p style={{ fontSize: 14, color: '#7D8FA9', lineHeight: 1.6, marginBottom: 20 }}>
            We&apos;ve sent a confirmation link to <strong style={{ color: '#1C2B4A' }}>{email}</strong>.
            Click the link to activate your account.
          </p>
          <Link href="/app/auth/login" style={{
            display: 'inline-block', padding: '10px 24px', borderRadius: 10,
            background: '#F5F7FB', color: '#1B4FFF', fontSize: 14, fontWeight: 600,
            textDecoration: 'none',
          }}>
            Back to sign in
          </Link>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 14, color: '#7D8FA9' }}>Get started with Finsyt — institutional-grade financial intelligence</p>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: 12, fontSize: 11, color: '#9BAFC8', lineHeight: 1.5 }}>
          By creating an account you agree to Finsyt&apos;s Terms of Service and Privacy Policy.
        </p>
      </div>
    </div>
  )

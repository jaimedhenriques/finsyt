  ...
  if (success) {
    return (
      <div style={{
        ...
        <div style={{
          width: '100%', maxWidth: 420, background: '#0D1525', borderRadius: 20,
          ...
          <p style={{ color: '#6B7F9B', fontSize: 14, lineHeight: 1.6, marginBottom: 24 }}>
            We&apos;ve sent a confirmation link to <strong style={{ color: '#E2E8F2' }}>{email}</strong>.
            Click the link to activate your account.
          </p>
          <Link href="/app/auth/login"
            style={{
              color: '#1B4FFF', fontSize: 14, fontWeight: 600, textDecoration: 'none',
            }}>
            ← Back to sign in
          </Link>
        </div>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: '#6B7F9B', fontSize: 14, margin: 0 }}>
            Get started with institutional-grade financial intelligence
          </p>
        </div>
        ...
        <button
          ...
          style={{
            ...
            background: 'rgba(255,255,255,0.05)', color: '#E2E8F2',
            fontSize: 14, fontWeight: 600, cursor: loading ? 'not-allowed' : 'pointer',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            gap: 10, fontFamily: 'inherit', transition: 'all 0.15s',

...
DECLARE
  t text;
  tables text[] := ARRAY['leads', 'research_notes', 'chat_messages', 'memberships', 'portfolio_positions', 'api_keys', 'alerts', 'workspaces', 'workspace_views', 'matrices', 'matrix_snapshots'];
BEGIN
